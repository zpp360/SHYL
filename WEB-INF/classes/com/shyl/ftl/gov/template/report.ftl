...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body id="top">
		...
		<h2 style="text-align: center;">${lastyear}年度离岸外包收入汇总表</h2>
		...
		<table id="appTable" bordercolor="black" cellspacing="1" class="table">
			<tr>
				...
				<td style="width: 13%; text-align: left;">离岸执行额（万美元）</td>
		...
		<tr>
				...
				<td><#if  contract.remarks??>
				<#if contract.remarks?? && contract.remarks?length lt 6>
					${contract.remarks}
				<#elseif contract.remarks??>

...
<body>
	<form  action="dictionaries/save.do" name="Form" id="Form" method="post" >
		...
		<table>
			<tr class="info">
				<td><input type="text" name="NAME" id="NAME" placeholder="这里输入名称" value="${pd.NAME }" title="名称" onblur="trim(this);" maxlength="50" onblur="trim(this);"/></td>
			</tr>
			<tr class="info">
				<td><input type="text" name="BIANMA" id="BIANMA" placeholder="这里输入编码" value="${pd.BIANMA }" title="编码" maxlength="50" onblur="trim(this);"/></td>
			</tr>
			<tr class="info">
				<td><input type="number" name="ORDY_BY" id="ORDY_BY" placeholder="这里输入序号" value="${pd.ORDY_BY}" title="序号" maxlength="10" onblur="trim(this);"/></td>
			</tr>
			<tr>

...
<script type="text/javascript">
	...
	function add(PARENT_ID){
		 ...
		 diag.Drag=true;
		 diag.Title ="新增";
		 diag.URL = dialogPath+'dictionaries/toAdd.do?PARENT_ID='+PARENT_ID;
		 diag.Width = 223;
		 diag.Height = 175;
	...
	function edit(ZD_ID){
		 ...
		 diag.Drag=true;
		 diag.Title ="编辑";
		 diag.URL = dialogPath+'dictionaries/toEdit.do?ZD_ID='+ZD_ID;
		 diag.Width = 223;
		 diag.Height = 175;
		 diag.CancelEvent = function(){ //关闭事件
			 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
...
<div class="row-fluid">
	...
	<table>
		<tr>
			...
			<td><input type="text" name="NAME" value="${pd.NAME }" placeholder="这里输入名称" style="width:130px;" maxlength="50" onblur="trim(this);"/></td>

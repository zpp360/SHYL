...
<body>
	<form  action="menu/add.do" name="menuForm" id="menuForm" method="post" >
		...
		<table>
			...
			<tr>
				<td><input type="text" name="MENU_NAME" id="menuName" placeholder="这里输入菜单名称" value="" title="名称" maxlength="50" onblur="trim(this);"/></td>
			</tr>
			<tr>
				<td><input type="text" name="MENU_URL" id="menuUrl" placeholder="这里输入链接地址" value="" title="地址" maxlength="50" onblur="trim(this);"/></td>
			</tr>
			<tr>
				<td><input type="number" name="MENU_ORDER" id="menuOrder" placeholder="这里输入序号" value="" title="序号" maxlength="50" onblur="trim(this);"/></td>
			</tr>
			<tr>

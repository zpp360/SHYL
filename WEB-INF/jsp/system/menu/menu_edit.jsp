	...
	<body>
		<form action="menu/edit.do" name="menuForm" id="menuForm" method="post">
			...
			<table>
				...
				<tr>
					<td><input type="text" name="MENU_NAME" id="menuName" placeholder="这里输入菜单名称" value="${pd.MENU_NAME }" title="名称" maxlength="50" onblur="trim(this);"/></td>
				</tr>
				<tr>
					<td><input type="text" name="MENU_URL" id="menuUrl" placeholder="这里输入链接地址" value="${pd.MENU_URL }" title="地址" maxlength="50" onblur="trim(this);"/></td>
				</tr>
				<tr>
					<td><input type="number" name="MENU_ORDER" id="menuOrder" placeholder="这里输入序号" value="${pd.MENU_ORDER}" title="序号" maxlength="50" onblur="trim(this);"/></td>
				</tr>
				<tr>

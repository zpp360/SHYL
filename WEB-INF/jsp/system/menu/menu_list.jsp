...
<script type="text/javascript">
	...
	function addmenu(){
		 ...
		 diag.Drag=true;
		 diag.Title ="新增菜单";
		 diag.URL = dialogPath+'menu/toAdd.do';
		 diag.Width = 223;
		 diag.Height = 256;
	...
	function editmenu(menuId){
		 ...
		 diag.Drag=true;
		 diag.Title ="编辑菜单";
		 diag.URL = dialogPath+'menu/toEdit.do?MENU_ID='+menuId;
		 diag.Width = 223;
		 diag.Height = 256;
		 diag.CancelEvent = function(){ //关闭事件
			if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
	...
	function editTb(menuId){
		 ...
		 diag.Drag=true;
		 diag.Title ="编辑图标";
		 diag.URL = dialogPath+'menu/toEditicon.do?MENU_ID='+menuId;
		 diag.Width = 530;
		 diag.Height = 150;
		 diag.CancelEvent = function(){ //关闭事件
			if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
...
<body>
	...
	<div class="page_and_btn">
		<div>
			&nbsp;&nbsp;
			<button type="button" class="btn btn-small btn-success btn-lg" onclick="addmenu();">

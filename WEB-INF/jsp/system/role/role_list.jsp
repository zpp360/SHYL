  ...
  <div class="row-fluid">
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function addRole(){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增组";
			 diag.URL = dialogPath+'role/toAdd.do?parent_id=0';
			 diag.Width = 222;
			 diag.Height = 90;
		...
		function addRole2(pid){
			 ...
			 diag.Drag=true;
			 diag.Title ="新增角色";
			 diag.URL = dialogPath+'role/toAdd.do?parent_id='+pid;
			 diag.Width = 222;
			 diag.Height = 90;
			 diag.CancelEvent = function(){ //关闭事件
				if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
		...
		function editRole(ROLE_ID){
			 ...
			 diag.Drag=true;
			 diag.Title ="编辑";
			 diag.URL = dialogPath+'role/toEdit.do?ROLE_ID='+ROLE_ID;
			 diag.Width = 222;
			 diag.Height = 90;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
		...
		function editRights(ROLE_ID){
			 ...
			 diag.Drag = true;
			 diag.Title = "菜单权限";
			 diag.URL = dialogPath+'role/auth.do?ROLE_ID='+ROLE_ID;
			 diag.Width = 280;
			 diag.Height = 370;
			 diag.CancelEvent = function(){ //关闭事件
				diag.close();
		...
		function roleButton(ROLE_ID,msg){
			...
			if(msg == 'add_qx'){
			 ...
			 diag.Drag = true;
			 diag.Title = Title;
			 diag.URL = dialogPath+'role/button.do?ROLE_ID='+ROLE_ID+'&msg='+msg;
			 diag.Width = 200;
			 diag.Height = 370;
			 diag.CancelEvent = function(){ //关闭事件
				diag.close();

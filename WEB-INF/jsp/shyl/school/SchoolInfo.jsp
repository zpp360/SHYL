...
<div class="register-box p0">
	...
	<jsp:include page="../common/left.jsp"><jsp:param value="17" name="menuType"/></jsp:include>
			...
			<div class="bd">
				<ul>
					<div class="inputmodify">
						<dl>
							<dd><span>当前密码 ： </span><input type="password" id="PassWord" name="PassWord" placeholder="请输入当前密码" class="inputtxt3" maxlength="20"></dd>
							<dd><span>新密码 ： </span><input type="password" id="NewPassWord" name="NewPassWord" placeholder="请输入新密码" class="inputtxt3" maxlength="20"></dd>
							<dd><span>确认密码 ： </span><input type="password" id="CPassWord" name="CPassWord" placeholder="与新密码一致" class="inputtxt3" maxlength="20"></dd>
						</dl>
				...
				<ul>
					<div class="inputmodify">
						<dl>
							<dd><span>邮箱 ： </span><input type="text" id="Email" name="Email" placeholder="请输入邮箱地址" class="inputtxt3"></dd>
						</dl>
 ...
 $(function(){
 	...
 	function savePwd(){
 		if(pwdCheck()){
 			$.ajax({
				type : "POST",
				url : '<%=basePath%>school/updatePwd.act',
				data : {

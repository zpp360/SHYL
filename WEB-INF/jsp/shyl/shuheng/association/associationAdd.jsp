...
<body>
	<br>
	<form action="<%=basePath%>association/saveAssociation.do" name="Form"
		id="Form" method="post">
		<div id="zhongxin">
			<table class="table ">
				<tr>
					...
					<td><input type="text" name="association_name"
						id="association_name" maxlength="40"
						style="height: 20px; width: 300px;" placeholder="请输入协会名称"
						title="协会名称" onblur="trim(this);" /></td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
						<B>上级协会</B>
					...
					<td><select class="chzn-select" name="parent_id"
						id="parent_id" data-placeholder="请选择上级协会"
						style="height: 20px; width: 315px;">
							<option value=""></option>
							<c:forEach items="${pList}" var="pr">
								<option value="${pr.association_id}">${pr.association_name}</option>
							</c:forEach>
					</select></td>
				</tr>
				...
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
						<span style="color: #C00; padding-right: 4px;">*</span><B>省</B> <input
						type="hidden" id="provinces" value="${pd.province_id}" />
					</td>
					<td>
						<select class="chzn-select" name="association_province" id="association_province" data-placeholder="请选择省" style="height: 20px; width: 315px;">
							<option value=""></option>
				...
				<tr>
					...
					<td>
						<c:if test="${not empty cityList}">
							<select class="chzn-select" name="association_city" id="association_city" data-placeholder="请选择市" style="height: 20px; width: 315px;">
								<option value=""></option>
								<c:forEach items="${cityList}" var="city">
									<option value="${city.id }"
										<c:if test="${city.id == pd.association_city}">selected</c:if>>${city.name }</option>
								</c:forEach>
							</select>
						</c:if> 
				...
				<tr>
					...
					<td>
						<c:if test="${not empty areaList}">
							<select class="chzn-select" name="association_county" id="association_county" data-placeholder="请选择区" style="height: 20px; width: 315px;">
								<option value=""></option>
				...
				<tr>
					...
					<td><input type="text" name="association_address"
						id="association_address" maxlength="80"
				...
				<tr>
					...
					<td><input type="text" name="association_linkman"
						id="association_linkman" maxlength="20"
				...
				<tr>
					...
					<td><input type="text" name="association_linkphone"
						id="association_linkphone" maxlength="11"
						style="height: 20px; width: 300px;" placeholder="请输入联系人手机号"
						title="联系人手机号" onkeyup="value=value.replace(/[^0-9]/g,'')" onblur="trim(this);" /></td>
				...
				<tr>
					...
					<td colspan='2'><textarea id="association_desc"
							name="association_desc" maxlength="500"
							style="width: 600px; height: 200px;" title="协会介绍"></textarea></td>
				</tr>
				<tr>
					<td></td>
					<td></td>

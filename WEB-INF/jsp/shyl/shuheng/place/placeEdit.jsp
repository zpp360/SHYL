...
<body>
<br>
	<form action="<%=basePath%>place/updatePlace.do" name="Form" id="Form" method="post">
		...
		<div id="zhongxin">
			<table class="table ">
				<tr>
					...
					<td>
						<input type="text" name="pName" id="pName" value="${pd.pName}" maxlength="30" style="height: 20px; width: 300px;" placeholder="请输入场地名称" title="场地名称" onblur="trim(this);"/>
					</td>
				</tr>
				...
				<tr>
					...
					<td>
						<select id="pType" name="pType" class="chzn-select" style="height: 20px; width: 315px;">
							<option value=""></option>
				...
				<tr>
					...
					<td>
						<input type="text" name="p_address" id="p_address" value="${pd.pAddress}" maxlength="200" style="height: 20px; width: 300px;" placeholder="请输入场地地址" title="场地地址" onblur="trim(this);"/>
					</td>
				</tr>
				<tr>
					...
					<td>
						<div class="form-group" id="businessDiv">
						    <div class="upload_img">
							   ...
							   <c:if test="${empty pd.pPath}">
								...
								<c:if test="${!empty pd.pPath}">
						        	<img id="weixin_show" name="weixin_show" style="width:auto; max-width: 200px; height: 150px;" onerror="showImgDelay(this,'<%=basePath%>shyl/images/temp.png');" src="${img_host}${pd.pPath}">
						        </c:if>
						...
						<div class="cut_img">
							...
							<input type="hidden" id="cutImage" name="cutImage" value="${pd.pPath}" placeholder="裁切图片"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					...
					<td><textarea id="pContent" name="pContent" maxlength="10000" style="min-height: 300px; margin: 0 auto; width: 90%;float:left" title="场地介绍">${pd.pContent}</textarea>
					</td>
				</tr>
				<tr>
					<td></td>

		...
		<div id="zhongxin">
			...
			<table class="table ">
				...
				<tr>
					...
					<td><select class="chzn-select" name="DEPART_ID" id="DEPART_ID" disabled="disabled"
						data-placeholder="部门名称"  style="height: 20px; width: 315px;">
							<option value=""></option>
				...
				<tr>
					...
					<td><input type="text" name="POS_NAME" id="POS_NAME"
						value="${pd.POS_NAME}" maxlength="40" disabled="disabled"
				...
				<tr>
					<td nowrap="nowrap"
						style="width: 80px; text-align: left; padding-top: 13px;"><B>简 介</B></td>

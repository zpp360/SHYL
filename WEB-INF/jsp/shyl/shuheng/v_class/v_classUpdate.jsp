...
<body>
	<br>
	<form action="<%=basePath%>volunteerClass/updateVolunteerClass.do" name="Form" id="Form" method="post">
		<input type="hidden" id="class_id" name="class_id" value="${pd.class_id}"/>
			<table class="table">
				<tr>
					...
					<td>
					    <input type="text" name="class_name" id="class_name" value="${pd.class_name}" maxlength="20" style="height: 20px; width: 300px;" placeholder="请输入名称" title="名称" onblur="trim(this);" />
					</td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
						<B>来源</B></td>
					<td>
					    <input type="text" name="class_source" id="class_source" value="${pd.class_source}" maxlength="20" style="height: 20px; width: 300px;" placeholder="请输入来源" title="来源" onblur="trim(this);" />
					</td>
				</tr>
				<tr>
					...
					<td>
						...
						<div class="cut_img">
							...
							<input type="hidden" id="cutImage" name="cutImage" value="${pd.class_img}" placeholder="裁切图片"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
						<B>内容</B></td>
					<td>
						<textarea name="class_txt" id="class_txt" style="min-height: 450px;">${pd.class_txt}</textarea>
					</td>
				</tr>
				<tr>
					<td></td>

...
<body>
<br>
	<form action="<%=basePath%>retire/save.do" name="Form" id="Form" method="post">
		...
		<div id="zhongxin">
			<table class="table ">
				...
				<tr>
					...
					<td><input type="text" name="user_phone" id="user_phone" maxlength="20"
				...
				<tr>
					...
					<td colspan="5"><input type="text" name="user_address" id="user_address" maxlength="200"
				...
				<tr>
					...
					<td colspan='2'><input type="text" name="user_idcard" id="user_idcard" maxlength="20"
					...
					<td colspan='2'><input type="text" name="user_birthday" id="user_birthday" maxlength="20" class="Wdate" value="${pd.organization_time}" readonly="readonly" onclick="WdatePicker({maxDate:'1935-10',dateFmt:'yyyy-MM',isShowClear:true});"
				...
				<tr>
					...
					<td colspan='2'><input type="text" name="user_old_unit" id="user_old_unit" maxlength="50"
					...
					<td colspan='2'><input type="text" name="user_old_job" id="user_old_job" maxlength="50"
				...
				<tr>
					...
					<td colspan='5'>
						<c:forEach items="${treatmentList}" var="list">
							<input type="checkbox" name="treatment"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
					</td>
				</tr>
				<tr>
					...
					<select class="chzn-select" name="user_unit" id="user_unit" <c:if test="${!is_super_admin}"> disabled="disabled"</c:if>
							...
							<c:forEach items="${unitList}" var="list">
								...
								<c:if test="${list.unit_id == user_unit }">selected</c:if>>${list.unit_name_full}</option>
							</c:forEach>
					</select></td>
					<td style="width: 70px; text-align: right;"><B>联系电话</B></td>
					<td colspan='2'><input type="text" name="unit_phone" id="unit_phone" maxlength="50"
						 style="height: 20px; width: 200px;margin-top: 10px;" placeholder="请输入单位联系电话"
				...
				<tr>
					...
					<td colspan="5">
						<c:forEach items="${liveTypeList}" var="list">
							<input type="checkbox" name="liveType"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan="2">
						<c:forEach items="${revolutionList}" var="list">
							<input type="radio" name="revolution_time"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
					</td>
					<td style="width: 70px; text-align: right;"><B>服务管理单位类型</B></td>
					<td colspan="2">
						<c:forEach items="${unitTypeList}" var="list">
							<input type="radio" name="old_unit_type"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
					</td>
				</tr>
				<tr>
					<td style="width: 85px; text-align: right;"><B>离休费标准(元/月)</B></td>
					<td colspan='2'><input type="number" name="retire_fee" id="retire_fee" maxlength="10" min="0" 
					...
					<td colspan='2'><input type="number" name="medical_fee" id="medical_fee" maxlength="10" min="0" 
				...
				<tr>
					...
					<td colspan='5'>
						<input type="radio" name="special_difficult"  value="1"  style="opacity:1;position: relative;top:4px;"/><span>是</span>
						<input type="text" name="help_unit" maxlength="30" style="display:none;height: 20px; width: 200px;margin-top: 10px;" placeholder="请输入救助单位"/>
						<input type="number" name="help_money" maxlength="10" style="display:none;height: 20px; width: 200px;margin-top: 10px;" placeholder="请输入救助金额"/>
						<input type="radio" name="special_difficult"  value="0"  style="opacity:1;position: relative;top:4px;"/><span>否</span>
					</td>
				</tr>
				<tr>
					<td style="width: 85px; text-align: right;"><B>享受居家养老服务</B></td>
					<td colspan='2'>
						<input type="radio" name="home_care"  value="1"  style="opacity:1;position: relative;top:4px;"/><span>是</span>
						<input type="radio" name="home_care"  value="0"  style="opacity:1;position: relative;top:4px;"/><span>否</span>
					</td>
					<td style="width: 70px; text-align: right;"><B>享受何种居家养老服务</B></td>
					<td colspan='2'><input type="text" name="home_care_service" id="home_care_service" maxlength="100"
				...
				<tr>
					...
					<td colspan='5'>
						<c:forEach items="${serviceList}" var="list">
							<input type="checkbox" name="hopeService"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
					</td>
				</tr>
				...
				<tr>
					...
					<td colspan="5">
						<c:forEach items="${healthStatusList}" var="list">
							<input type="radio" name="health_status"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
					</td>
				</tr>
				<tr>
					...
					<td colspan='2'>
						<input type="radio" name="join_health"  value="1"  style="opacity:1;position: relative;top:4px;"/><span>是</span>
						<input type="radio" name="join_health"  value="0"  style="opacity:1;position: relative;top:4px;"/><span>否</span>
					</td>
					<td style="width: 70px; text-align: right;"><B>保健证编号</B></td>
					<td colspan='2'><input type="text" name="health_id_number" id="health_id_number" maxlength="50"
				...
				<tr>
					...
					<td colspan='2'><input type="text" name="hospital_one" id="hospital_one" maxlength="30"
					...
					<td colspan='2'><input type="text" name="hospital_two" id="hospital_two" maxlength="30"
				...
				<tr>
					...
					<td colspan="5">
						<c:forEach items="${illnessList}" var="list">
							<input type="checkbox" name="illness"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
						<span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;其它：</span><input type="text" name="illness_other" id="illness_other" maxlength="50"
				...
				<tr>
					...
					<td colspan='5'><input type="text" name="medicine_in"  maxlength="50"
						 style="height: 20px; width: 100px; margin-top: 10px;"
						 placeholder="医保内用药" title="医保内用药" onblur="trim(this);"/><i class="small-icon fa fa-plus-square" style="cursor:pointer;color: #219823;" onclick="addMedicine(this,'in')" title="添加选项"></i></td>
				</tr>
				<tr>
					<td style="width: 70px; text-align: right;"><B>长期服用医保外药物</B></td>
					<td colspan='5'><input type="text" name="medicine_out"  maxlength="50"
						style="height: 20px; width: 100px; margin-top: 10px;" placeholder="医保外用药"
						title="医保外用药" onblur="trim(this);"/><i class="small-icon fa fa-plus-square" style="cursor:pointer;color: #219823;" onclick="addMedicine(this,'out')" title="添加选项"></i></td>
				</tr>
				...
				<tr>
					...
					<td colspan='2'><input type="text" name="party_branch" id="party_branch" maxlength="50"
					...
					<td colspan='2'>
						<input type="radio" name="send_study"  value="1"  style="opacity:1;position: relative;top:4px;"/><span>是</span>
						<input type="radio" name="send_study"  value="0"  style="opacity:1;position: relative;top:4px;"/><span>否</span>
					</td>
				</tr>
				<tr>
					<td style="width: 85px; text-align: right;"><B>定期参加支部活动</B></td>
					<td colspan='2'>
						<input type="radio" name="party_branch_active"  value="1"  style="opacity:1;position: relative;top:4px;"/><span>是</span>
						<input type="radio" name="party_branch_active"  value="0"  style="opacity:1;position: relative;top:4px;"/><span>否</span>
					</td>
					<td style="width: 70px; text-align: right;"><B>党费缴纳方式</B></td>
					<td colspan='2'>
						<c:forEach items="${feeWayList}" var="list">
							<input type="radio" name="party_fee_way"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
					</td>
				</tr>
				<tr>
					...
					<td colspan='2'>
						<input type="radio" name="interview"  value="1"  style="opacity:1;position: relative;top:4px;"/><span>是</span>
						<input type="radio" name="interview"  value="0"  style="opacity:1;position: relative;top:4px;"/><span>否</span>
					</td>
					<td style="width: 70px; text-align: right;"><B>每年几次</B></td>
					<td colspan='2'>
						<c:forEach items="${interviewList}" var="list">
							<input type="radio" name="interview_year"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
					</td>
				</tr>
				<tr>
					...
					<td colspan='2'>
						<input type="radio" name="join_active"  value="1"  style="opacity:1;position: relative;top:4px;"/><span>能</span>
						<input type="radio" name="join_active"  value="0"  style="opacity:1;position: relative;top:4px;"/><span>不能</span>
					</td>
				</tr>
				<tr>
					...
					<td colspan='5'>
						<c:forEach items="${interestList}" var="list">
							<input type="checkbox" name="interest"  value="${list.distinguish_id}"  style="opacity:1;position: relative;top:4px;"/><span>${list.value}</span>
						</c:forEach>
					</td>
				</tr>
			</table>
			...
			<table class="table">
				...
				<tr>
					...
					<td clospan="5"><textArea  name="suggestion_live" class="suggestion_live" maxlength="500" 
						...
						title="" onblur="trim(this);"></textArea></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td colspan='2'><input type="text" name="data_user" id="data_user" maxlength="20"
						 style="height: 20px; width: 200px; margin-top: 10px;" placeholder="请输入信息采集人"
						title="信息采集人" onblur="trim(this);" /></td>
					<td style="width: 100px; text-align: right;"><B>采集人手机号</B></td>
					<td colspan='2'><input type="text" name="data_user_phone" id="data_user_phone" maxlength="20"

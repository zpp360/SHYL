		...
		<input type="hidden" name="screenings_id" id="screenings_id" value="${pd.screenings_id }"/>
			<table class="table ">
				<tr>
					...
					<td><select class="chzn-select" name="film_name" id="film_name"
				...
				<tr>
					...
					<td><select class="chzn-select" name="sc_address" id="sc_address"
				...
				<tr>
					...
					<td><input type="text" value="${pd.screenings_start_time}"  name="START_TIME" id="START_TIME"  placeholder="开始时间"  title="开始时间" style=" width: 300px"/></td>
				</tr>
				
				<tr>
					<td style="width: 80px; text-align: left; padding-top: 13px;"><span style="color:#C00;padding-right: 4px;">*</span><B>结束时间</B></td>
					<td><input name="END_TIME" id="END_TIME" value="${pd.screenings_end_time}" type="text"  placeholder="结束时间"  title="结束时间" style=" width: 300px"/></td>
				</tr>
				<tr>
					<td></td>
					<td></td>

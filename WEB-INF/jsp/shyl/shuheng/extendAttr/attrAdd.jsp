...
<br>
		...
		<div id="zhongxin">
			<table class="table ">
				<tr>
					...
					<td><input type="text" name="attr_name" id="attr_name" maxlength="40"
	...
	<script type="text/javascript">
		...
		//返回
	    function returnback(){
	    	window.location.href="<%=basePath%>attr_type/list.do";
		}
		$(function() {
			//下拉框
			$(".chzn-select").chosen();

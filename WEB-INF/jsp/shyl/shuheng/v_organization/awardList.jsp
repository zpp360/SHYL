...
<!-- 							</tr> -->
						...
						<hr/>
						<form action="<%=basePath%>vOrg/awardList.do?organization_id=${pd.organization_id}" method="post" name="Form" id="Form">
		...
		$(function() {
			...
			$('[name=ids]').click(function() {
				if(this.checked){
					$.ajax({
						type: "POST",
						url: "<%=basePath%>vOrg/awardInfo.do",
						data:
							{
							award_id:this.value
							},
		...
		function deleteAward(award_id){
			bootbox.confirm("确定要删除吗?", function(result) {
				if(result) {
					...
					$.ajax({
						type: "POST",
						url: "<%=basePath%>vOrg/deleteAward.do",
						data:
							{
							award_id:award_id
							},

...
<body>
	...
	<form action="<%=basePath%>film/${msg }.do" name="Form" id="Form" method="post">
		...
		<div id="zhongxin">
			<table class="table">
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;"><span
						style="color: #C00; padding-right: 4px;">*</span><B>电影名称</B></td>
					<td><input type="text" name="filmName" id="filmName"
						maxlength="50" style="height: 20px; width: 300px;"
						placeholder="请输入电影名称" title="电影名称" onblur="trim(this);" /></td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;"><span
						style="color: #C00; padding-right: 4px;">*</span><B>导演名称</B></td>
					<td><input type="text" name="director" id="director"
						maxlength="60" style="height: 20px; width: 300px;"
						placeholder="请输入导演名称" title="导演名称" onblur="trim(this);" /></td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;"><span
						style="color: #C00; padding-right: 4px;">*</span><B>电影主演</B></td>
					<td><input type="text" name="performer" id="performer"
						maxlength="80" style="height: 20px; width: 300px;"
						placeholder="请输入电影主演" title="电影主演" onblur="trim(this);" /></td>

				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;"><span
						style="color: #C00; padding-right: 4px;">*</span><B>电影时长</B></td>
					<td><input type="text" name="filmTime" id="filmTime"
						maxlength="3" style="height: 20px; width: 300px;"
						placeholder="默认分钟" title="电影时长" onblur="trim(this);" /></td>
				...
				<tr>
					...
					<td>
						<input type="text" name="filmLanguage" id="filmLanguage" maxlength="30" style="height: 20px; width: 300px;" placeholder="请输入电影语言" title="电影语言" onblur="trim(this);" />
					</td>
				...
				<tr>
					...
					<td>
						<input type="text" name="filmLocal" id="filmLocal" maxlength="30" style="height: 20px; width: 300px;" placeholder="请输入上映地区" title="上映地区" onblur="trim(this);" />
					</td>
				...
				<tr>
					...
					<td id="good">
						<span>
							...
							<input name="filmStartDate" id="filmStartDate" class="Wdate" value="${pd.filmStartDate}" type="text" readonly="readonly" placeholder="请选择开始日期" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'filmEndDate\',{d:-0});}',dateFmt:'yyyy-MM-dd HH:mm',isShowClear:true});"/>
							- <input name="filmEndDate" id="filmEndDate" class="Wdate" value="${pd.filmEndDate}" type="text" readonly="readonly" placeholder="请选择结束日期" onclick="WdatePicker({minDate:'#F{$dp.$D(\'filmStartDate\',{d:0});}',dateFmt:'yyyy-MM-dd HH:mm',isShowClear:true});"/>
				...
				<tr>
					...
					<td>
						<div class="upload_img">
							<input id="filmPath" name="filmPath" type="hidden" />

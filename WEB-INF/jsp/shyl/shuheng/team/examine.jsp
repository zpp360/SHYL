...
<body>
	...
	<form name="Form" id="Form" method="post">
		...
		<div id="zhongxin">
			<table class="table">
				...
				<tr>
					...
					<td><textarea id="reason" name="reason" maxlength="500" style="min-height: 200px;width: 800px;"></textarea></td>
				</tr>
				<tr>
					<td></td>
					<td></td>
		...
		<div align="center" style="margin-top: 10px; width:1000px;">
			<a class="btn  btn-success" onclick="save('0');"><i class="icon-save"></i>通过</a> 
			<a class="btn  btn-success" onclick="save('1');"><i class="icon-save"></i>不通过</a> 

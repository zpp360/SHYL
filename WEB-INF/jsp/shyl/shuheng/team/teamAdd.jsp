		...
		<div id="zhongxin">
			<table class="table">
				<tr>
					...
					<td>
						<input type="text" name="team_name" id="team_name" maxlength="50" style="height: 20px; width: 300px;" placeholder="请输入名称" title="名称" onblur="trim(this);"/>
					</td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
				...
				<tr>
					...
					<td>
						<span>
							<input name="team_time" id="team_time" class="Wdate" type="text" readonly="readonly" placeholder="请选择时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm',isShowClear:true});"/>
						</span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<span>
							<input style="width:90px;" name="app_user_name" id="app_user_name" type="text" readonly="readonly" placeholder="请选择负责人" onclick="selectRadioUser()"/>
							<input style="width:50px;" name="app_user_age" id="app_user_age" type="text" readonly="readonly"/>
							<input name="app_user_job" id="app_user_job" type="text" readonly="readonly"/>
				...
				<tr>
					...
					<td>
						<span>
							<input name="user_num" id="user_num" type="text" readonly="readonly" placeholder="0人" onclick="selectUser()"/>
				...
				<tr>
					...
					<td><textarea id="team_activity" name="team_activity" maxlength="10000" style="min-height: 450px;"></textarea></td>
				</tr>
				<tr>
					<td style="width: 80px; text-align: left; padding-top: 13px;">
						<B>获奖图1</B>
				...
				<tr>
					...
					<td><textarea id="team_award" name="team_award" maxlength="10000" style="min-height: 450px;"></textarea></td>
				</tr>
				<tr>
					<td></td>
					<td></td>
...
// 	        max_file_size : '30720kb', //最大只能上传100M的文件
	...
	//详情
	    ...
	    */
	    function save(status){
			...
			$("#Form").attr("action","<%=basePath%>team/saveTeam.do?status="+status);
	    	$("#Form").submit();
	    	$("#zhongxin").hide();
	    	$("#zhongxin2").show();

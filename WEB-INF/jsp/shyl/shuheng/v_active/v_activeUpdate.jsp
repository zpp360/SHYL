...
<!-- 				</tr> -->
				<tr>
					...
					<td>
					    <input type="text" name="active_name" id="active_name" value="${pd.active_name}" maxlength="50" style="height: 20px; width: 300px;" placeholder="请输入名称" title="名称" onblur="trim(this);" />
					</td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
				...
				<tr>
					...
					<td>
						<span>
							<input name="active_start_time" id="active_start_time" value="${pd.active_start_time}" class="Wdate" type="text" readonly="readonly" placeholder="请选择开始时间" onclick="WdatePicker({maxDate:'#F{$dp.$D(\'active_end_time\',{d:-0});}',dateFmt:'yyyy-MM-dd HH:mm',isShowClear:true});"/>
							- <input name="active_end_time" id="active_end_time" value="${pd.active_end_time}" class="Wdate" type="text" readonly="readonly" placeholder="请选择结束时间" onclick="WdatePicker({minDate:'#F{$dp.$D(\'active_start_time\',{d:0});}',dateFmt:'yyyy-MM-dd HH:mm',isShowClear:true});"/>
						</span>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input type="text" name="active_love_hour" id="active_love_hour" value="${pd.active_love_hour}" readonly="readonly" style="height: 20px; width: 300px;" title="爱心小时数" onblur="trim(this);" />					
					</td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
					...
					<td>
						<input type="text" name="active_linkman" id="active_linkman" value="${pd.active_linkman}" maxlength="20" style="height: 20px; width: 300px;" placeholder="请输入联系人" title="联系人" onblur="trim(this);" />					
					</td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
					...
					<td>
						<input type="text" name="active_linkman_phone" id="active_linkman_phone" value="${pd.active_linkman_phone}" maxlength="11" style="height: 20px; width: 300px;" placeholder="请输入联系方式" title="联系方式" onkeyup="value=value.replace(/[^0-9]/g,'')" onblur="trim(this);" />					
					</td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
					...
					<td>
						<input type="text" name="active_count" id="active_count" value="${pd.active_count}" maxlength="11" style="height: 20px; width: 300px;" placeholder="请输入招募人数" title="招募人数" onkeyup="value=value.replace(/[^0-9]/g,'')" onblur="trim(this);" />					
					</td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
				...
				<tr>
					...
					<td>
					    <input type="text" name="active_address_hidden" id="active_address_hidden" value="${pd.active_address}" placeholder="${pd.active_address}" maxlength="200" style="height: 20px; width: 300px;" title="活动地点" onblur="trim(this);" />
					    <input type="hidden" name="active_address" id="active_address" value="${pd.active_address}"/>
				...
				<tr>
					...
					<td>
						...
						<div class="cut_img">
							...
							<input type="hidden" id="cutImage" name="cutImage" value="${pd.active_img}" placeholder="裁切图片"/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
						<B>活动详情</B></td>
					<td>
						<textarea name="active_desc" id="active_desc" maxlength="200" rows="20px" cols="" style="width: 1200px;">${pd.active_desc}</textarea>
					</td>
				</tr>
				<tr>
					<td></td>
    ...
    function onHighLight(ac,map,idStr){
		...
		$(document).ready(function(){
			...
			$("#active_address_hidden").focus(function(){
				$("#meeting_place_map").show();
			});
			$("#active_address_hidden").blur(function(){
	    ...
	    function save(){
	    	...
	    	if($("#active_address_hidden").val()!=''){
	    		$("#active_address").val($("#active_address_hidden").val());
	    	}

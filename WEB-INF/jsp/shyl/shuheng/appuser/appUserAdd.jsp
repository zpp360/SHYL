		...
		<div id="zhongxin">
			<table class="table ">
				<tr>
					...
					<td><input type="text" name="user_name" id="user_name" maxlength="40"
					...
					<td>
						<select class="chzn-select" name="mz_code" id="mz_code" style="height: 20px; width: 315px;" >
							<c:forEach items="${selectMzList}" var="list">
								<option value="${list.mz_code}">${list.mz_name}</option>
							</c:forEach>
						</select>
					</td>
				</tr>
				<tr>
					...
					<td>
						<input name="user_birthday" id="user_birthday" class="Wdate"  type="text" data-date-format="yyyy-mm-dd" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true,maxDate:'%y-%M-%d'});" readonly="readonly" placeholder="请选择出生日期"  title="出生日期" style=" width: 300px"/>
					</td>
				</tr>
				<tr>
					<td style="width: 80px; text-align: left; padding-top: 13px;">
					...
					<td>
						<input type="text" name="user_job" id="user_job" maxlength="50" style="height: 20px; width: 300px;" placeholder="请输入职务" title="职务" onblur="trimAll(this);" />	
					</td>
				</tr>
				...
				<tr>
					...
					<td><input type="text" name="user_phone" id="user_phone" maxlength="11"
				...
				<tr>
					...
					<td><input type="text" name="user_id_number" id="user_id_number" maxlength="18"
				...
				<tr>
					...
					<td><input class="span10 date-picker" name="user_join_party_time" id="user_join_party_time" class="Wdate"  type="text" data-date-format="yyyy-mm-dd" onclick="WdatePicker({dateFmt:'yyyy-MM-dd',isShowClear:true});" readonly="readonly" placeholder="入党时间"  title="入党时间" style=" width: 300px"/></td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td><input type="text" name="user_address" id="user_address" maxlength="200"
				...
				<tr>
					...
					<td>
						<div class="upload_img">
							<input id="user_pic" name="user_pic" type="hidden" />

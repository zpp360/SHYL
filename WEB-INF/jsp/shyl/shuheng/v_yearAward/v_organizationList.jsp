	...
	<div class="container-fluid" id="main-container">
		<div id="page-content" class="clearfix">
			<div class="row-fluid">
				<div class="row-fluid">
					<!-- 检索  -->
					<form action="<%=basePath%>volunteerYearAward/toOrganization.do" method="post" name="Form" id="Form">
					<input type="hidden" id="organization_id" name="organization_id" value="${pd.organization_id}" style="width: 1000px;"/>
							...
							<tr>
								<td class="form-inline">
									...
									<span class="input-icon"> <input
											autocomplete="off" id="organization_name" type="text"
											name="organization_name" value="${pd.organization_name}"
...
<!-- 											<input type="checkbox" id="zcheckbox" /><span class="lbl"></span> -->
									...
									<th class="center" style="width:30%;">主管单位</th>
								</tr>
							</thead>
							<tbody>
								<!-- 开始循环 -->
									...
									<c:when test="${not empty pdList}">
											<c:forEach items="${pdList}" var="list" varStatus="vs">
												<tr>
													...
													<td class="center tds">${list.organization_name}</td>
													<td class="center tds">
													...
													<td class="center tds" title="${list.organization_city}">${list.organization_city} </td>
													<td class="center tds" title="${list.organization_county}">${list.organization_county}</td>

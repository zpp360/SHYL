...
<body>
	...
	<form action="<%=basePath%>wages/excelimport.do" name="Form" id="Form" method="post" enctype="multipart/form-data">
		<div id="zhongxin">
		<table style="width:95%;" >
			...
			<tr>
				<td style="text-align: center;">
					...
					<a class="btn btn-mini btn-success" onclick="window.location.href='<%=basePath%>/templateFiles/unit.xlsx'">下载模版</a>
				</td>
			</tr>
		</table>
		</div>

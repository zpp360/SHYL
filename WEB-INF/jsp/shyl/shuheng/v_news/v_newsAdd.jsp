	...
	<form action="<%=basePath%>volunteerNews/saveNews.do" name="Form" id="Form" method="post">
			<table class="table">
				<tr>
					...
					<td>
					    <input type="text" name="news_title" id="news_title" maxlength="100" style="height: 20px; width: 300px;" placeholder="请输入标题" title="标题" onblur="trim(this);" />
					</td>
				</tr>
				<c:if test="${pd.flag}">
					<tr>
					...
					<td>
						<select id="active_id" class="chzn-select" name="active_id"  data-placeholder="请选择活动"  style="height: 20px; width: 315px;">
								...
								<c:forEach items="${selectOrganizationList}" var="list">
									<option value="${list.active_id}">${list.active_name}</option>
								</c:forEach>
						</select>
					</td>
				</tr>
				...
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
						<B>来源</B></td>
					<td>
					    <input type="text" name="news_source" id="news_source" maxlength="100" style="height: 20px; width: 300px;" placeholder="请输入来源" title="来源" onblur="trim(this);" />
					</td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
					...
					<td>
						<span>
							<input name="release_time" id="release_time" class="Wdate" type="text" readonly="readonly" placeholder="请选择发布时间" onclick="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss',isShowClear:true});"/>
						</span>
					</td>
				</tr>
				<tr>
				...
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
						<B>内容</B></td>
					<td>
						<textarea name="news_content" id="news_content" rows="20px" cols="" style="width: 1200px;height: 500px;"></textarea>
					</td>
				</tr>
				<tr>
					<td></td>

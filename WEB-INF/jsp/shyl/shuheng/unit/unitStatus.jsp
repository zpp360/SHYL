...
<body>
	...
	<input type="hidden" id="distinguish_id" name="distinguish_id"/>
	<input type="checkbox" name="defaultValue" id="defaultValue" value="0" style="opacity:1;position: relative;"/>&nbsp;&nbsp;默认
</body>
...
// 		zTree.expandAll(true);//默认展开所有节点 
		...
		$("#distinguish_id").val(str);

		//默认值
		$('[name=defaultValue]').click(function(){
			if(this.checked){
				$("#defaultValue").val("1");
			}else{
				$("#defaultValue").val("0");
		...
		//回传 默认值
		var selectUnitStatusList = ${selectUnitStatusList};
		$.each(selectUnitStatusList,function(i,obj){

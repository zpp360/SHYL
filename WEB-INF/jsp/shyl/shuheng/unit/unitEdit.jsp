		...
		<div id="zhongxin">
			<table class="table ">
				<tr>
					...
					<td><input type="text" name="unit_name" id="unit_name" maxlength="40" value="${pd.unit_name_full }"
				...
				<tr>
					...
					<td><input type="text" name="unit_name_abbreviation" id="unit_name_abbreviation" maxlength="40" value="${pd.unit_name_abbreviation }"
				...
				<tr>
					...
					<td><input type="text" name="unit_address" id="unit_address" maxlength="80" value="${pd.unit_add }"
						...
						title="单位地址" onblur="trim(this);" /></td>
				...
				<tr>
					...
					<td><textarea id="unit_content" name="unit_content" maxlength="10000" 
							...
							title="单位介绍">${pd.introduction }</textarea></td>
				</tr>
				<tr>
					<td></td>
					<td></td>

...
<body>
	...
	<form name="Form" id="Form" method="post">
		<input type="hidden" id="banner_id" name="banner_id" value="${pd.banner_id}"/>
		...
		<div id="zhongxin">
			<table class="table">
				<tr>
					...
					<td>
						<input type="text" name="banner_title" id="banner_title" value="${pd.banner_title}" maxlength="50" style="height: 20px; width: 300px;" placeholder="请输入标题" title="标题" onblur="trim(this);"/>
					</td>
				</tr>
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;">
					...
					<td>
						<div class="form-group" id="businessDiv">
						    <div class="upload_img">
							    <input id="banner_img" name="banner_img" type="hidden" value="${pd.banner_img}"/>
	    ...
	    /**
		    ...
		    */
		    function save(){
				...
				$("#Form").attr("action","<%=basePath%>app/updateBanner.do");
		    	$("#Form").submit();
		    	$("#zhongxin").hide();
		    	$("#zhongxin2").show();

...
<body>
<br>
	<form action="<%=basePath%>volunteerUnit/save.do" name="Form" id="Form" method="post">
		<input type="hidden" name="unit_id" value="${pd.unit_id }" />
		<div id="zhongxin">
			<table class="table ">
				<tr>
					<td style="width: 100px; text-align: left; padding-top: 13px;"><span style="color:#C00;padding-right: 4px;">*</span><B>需求单位名称</B></td>
				...
				<tr>
					...
					<td><input type="text" name="unit_linkman" id="unit_linkman" maxlength="20"
				...
				<tr>
					...
					<td><input type="text" name="unit_phone" id="unit_phone" maxlength="20"
				...
				<tr>
					...
					<td><input type="text" name="unit_idcard" id="unit_idcard" maxlength="20"
				...
				<tr>
					...
					<td><input type="text" name="unit_email" id="unit_email" maxlength="50"
				...
				<tr>
					...
					<td><textarea id="unit_desc" name="unit_desc" maxlength="10000" 

...
<meta charset="utf-8" />
<title>指南发布_济南市服务外包公共服务平台</title>
		...
		<div id="zhongxin">
			<table class="table ">
				...
				<tr>
					...
					<td><input type="text" name="title" id="title" maxlength="50"
						style="height: 20px; width: 300px;margin-top:2px;" placeholder="请输入指南名称"
				...
				<tr>
					...
					<td><input type="text" name="guide_sources" id="guide_sources"
						maxlength="50" style="height: 20px; width: 300px;margin-top:2px"
						placeholder="请输入指南来源" title="指南来源" onblur="trim(this);" /></td>
				</tr>
				<tr>

...
<form action="<%=basePath%>dict/${msg}.do" name="Form" id="Form" method="post">
        <input type="hidden" name="parent" value="${pd.id}"/>
		<div id="zhongxin">
		<table style="margin-left:5px;">
			<tbody>
			<tr>
			    <td><label class="lbl" for="distinguish_key">区分Key：</label></td>
				<td><input name="distinguish_key" id="distinguish_key" placeholder="区分Key"  title="区分Key" type="text" maxlength="20" onblur="trim(this);"></td>
			</tr>
			<tr>
			    <td><label class="lbl" for="distinguish_name" >区分名称：</label></td>
				<td><input name="distinguish_name" id="distinguish_name" placeholder="区分名称"  title="区分名称" type="text" maxlength="50" onblur="trim(this);"></td>
			</tr>
			<tr>
			    <td><label class="lbl" for="value">区分内容：</label></td>
				<td><input name="value" id="value" placeholder="区分内容"  title="区分内容" maxlength="255" type="text" onblur="trim(this);"></td>
			</tr>
			<tr>
			    <td><label class="lbl" for="sort">区分排序：</label></td>
				<td><input name="sort" id="sort" placeholder="区分排序" onkeyup="value=value.replace(/[^0-9]/g,'')" 
				title="区分排序" maxlength="3" type="text" onblur="delZero(this);" style="ime-mode:disabled" value="0"></td>
			</tr>

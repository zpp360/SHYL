		...
		<input type="hidden" name="news_id" id="news_id" value="${pd.news_id }"/>
			<table class="table ">
				...
				<tr>
					...
					<td><input type="text" name="title" id="title" value="${pd.title}" maxlength="40"
				...
				<tr>
					...
					<td><input type="text" name="news_sources" id="news_sources" value="${pd.news_sources}" maxlength="40"
						...
						<div class="form-group" id="businessDiv">
						    <div class="upload_img">
							   ...
							   <c:if test="${empty pd.news_thumbnail}">
								...
								<c:if test="${!empty pd.news_thumbnail}">
						        	<img id="weixin_show" name="weixin_show" style="width: 158px; height: 190px;" onerror="showImgDelay(this,'<%=basePath%>shyl/images/temp.png');" src="<%=basePath%>images/${pd.news_thumbnail}">
						        </c:if>
				...
				<tr>
					...
					<td>
						<div class="form-group" id="businessDiv">
						    <div class="upload">
							    <input id="appendix_path" name="appendix_path" maxlength="500" type="hidden" value="${pd.appendix_path}"  />
								<input id="appendix_name" name="appendix_name" maxlength="100" type="hidden" value="${pd.appendix_name}"  />
							   	<input type="text" id="docName" value="${pd.appendix_name}" maxlength="100"  style="height: 20px; width: 300px;"  readonly="readonly" />
								<a href="javascript:;" class="a-upload" style="text-decoration:none; color:#ffffff;" id="fileDiv">上传本地附件
								<input type="file" id="file_upload" placeholder="上传本地附件" name="file_upload" multiple></a>
								<a href="javascript:;" style="text-decoration:none; color:#ffffff;left: 450px" onclick="removeAppendix('${pd.news_id}','${pd.appendix_path}')">移除附件</a>

...
<body>
<br/><br/>
	<form action="<%=basePath%>question/updateField.do" name="Form" id="Form" method="post">
		...
		<table style="margin-left:5px;">
			...
			<tr>
				...
				<td><input name="field_name" id="field_name" value="${pd.field_name}" title="题库类型" type="text" maxlength="20" onblur="trim(this);"></td>
			</tr>
			<tr>
			    <td><label class="lbl" for="memo" >题库描述：</label></td>
				<td><textarea rows="5" cols="" maxlength="100" style="resize:none" name="memo" id="memo" placeholder="请输入题库描述">${pd.memo}</textarea></td>
			</tr>

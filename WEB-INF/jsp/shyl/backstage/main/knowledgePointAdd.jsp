...
<body>
	<form action="knowledge/savePoint.do" name="Form" id="Form" method="post">
		<div id="zhongxin">
			...
			<tbody>
				...
				<tr>
					...
					<td><input name="point_name" id="point_name" placeholder="请输入知识点名"  title="知识点名" type="text" maxlength="20" onblur="trim(this);"></td>
				</tr>
				<tr>
					<td><label class="lbl" for="name">&#12288;&#12288;描述：</label></td>
					<td><textarea rows="5" cols="" style="resize:none" maxlength="100" name="memo" id="memo" placeholder="请输入知识点描述"></textarea></td>
				</tr>

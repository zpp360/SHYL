...
<head>
<base href="<%=basePath%>">
<title>个人信息数据分析_济南市服务外包公共服务平台</title>
<!-- jsp文件头和头部 -->
						...
						<table id="table_report"
							...
							<tbody>
								<tr>
									...
									<td>
										<div id="single_column2div" style="width: 600px;height:400px;"></div>
									</td>
								</tr>
								<tr>
									<td>
										<div id="single_column3Ddiv" style="width: 900px;height:400px;"></div>
									</td>
									<td>
										<div id="single_area2Ddiv" style="width: 600px;height:400px;"></div>
									</td>
								</tr>
							</tbody>
						</table>
    ...
    function educationCnt() {
		...
		var myChart = echarts.init(document.getElementById('single_Linediv'),e_macarons);
		 var education = new Array();
	    	...
	    	$.ajax({
	    		type:"POST",
	    		url:"<%=basePath%>statisticsUser/single_line.do",
	    		async: false,
	    		data : {
    ...
    function salaryCnt(){
		...
		var myChart = echarts.init(document.getElementById('single_column3Ddiv'),e_macarons);
		 var education = new Array();
	    	...
	    	$.ajax({
	    		type:"POST",
	    		url:"<%=basePath%>statisticsUser/single_column3D.do",
	    		async: false,
	    		data : {
	    			START_TIME : START_TIME,
	    			END_TIME : END_TIME
    ...
    function languageCnt(){
		...
		var myChart = echarts.init(document.getElementById('single_column2div'),e_macarons);
		 var education = new Array();
	    	...
	    	$.ajax({
	    		type:"POST",
	    		url:"<%=basePath%>statisticsUser/single_column2D.do",
	    		async: false,
	    		data : {
	    			START_TIME : START_TIME,
	    			END_TIME : END_TIME
...
"#D7504B","#F4E001","#26C0C0","#F0805A","#C1232B"
	...
	function jobTimeCnt(){
		...
		var myChart = echarts.init(document.getElementById('single_area2Ddiv'),e_macarons);
	    	...
	    	$.ajax({
	    		type:"POST",
	    		url:"<%=basePath%>statisticsUser/single_area2D.do",
	    		async: false,
	    		data : {
	    			START_TIME : START_TIME,
	    			END_TIME : END_TIME
	    		...
	    		success : function(responseText) {
	    			console.log(responseText);
	    				valueDate.push(responseText.studentCount.studentCnt);
	    				valueDate.push(responseText.oneYearCount.oneYearCnt);
	    				valueDate.push(responseText.twoYearCount.twoYearCnt);
	    				valueDate.push(responseText.threeYearCount.threeYearCnt);
	    				valueDate.push(responseText.fiveYearCount.fiveYearCnt);
	    				valueDate.push(responseText.eightYearCount.eightYearCnt);
	    				valueDate.push(responseText.tenYearCount.tenYearCnt);
	    		}
	    	});
			option = {
			    title : {
			    ...
			    xAxis : [
			        {
			            ...
			            type : 'category',
			            boundaryGap : true,
			            data :['1年以下','1年以上','2年以上','3年以上','5年以上','8年以上','10年以上']
			        }
			    ],
			    yAxis : [
			        {

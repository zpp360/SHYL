	...
	<jsp:include page="../../common/left.jsp"><jsp:param value="5" name="menuType"/></jsp:include>
		<div class="mypage_right">
			...
			<div class="tab" style="margin-bottom:0;">
				<form action="<%=basePath%>/company/collectionInfo/list.act" method="post" name="collectionform" id="collectionform">
...
<div class="modal_h20 fade bs-example-modal-sm in" id="deljob" data-toggle="modal" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel" aria-hidden="false" data-target=""><div class="modal-dialog modal-sm">
	...
	<script type="text/javascript">
	    function Delete() {
	    	var url= "<%=basePath%>company/collectionInfo/del.act";
	        $.post(url, { id: $("#collectionInfoId").val()}, function (data) {
	        	if(data.result==1){
	        		location.href = '<%=basePath%>company/collectionInfo/list.act';
	        	}else{
	        		alert("删除失败");
	        	}

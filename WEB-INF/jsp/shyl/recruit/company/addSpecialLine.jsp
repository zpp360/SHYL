...
<html lang="en">
<head>
<title>专线明细信息添加_济南市服务外包公共服务平台</title>
<meta charset="UTF-8" />
...
function save(){
	if(localcheck()){
		$("#lineForm").attr('action','<%=basePath%>line/saveLine.act');
		$("#lineForm").submit();
	}
}
			...
			<form class="form-horizontal company_list" role="form" id="lineForm" name="lineForm" action="" method="post">
				...
				<div class="input_class">
					...
					<li style="width: 800px;">
						...
						<input type="text" class="inputtxt2" style="width: 500px;" maxlength="20" id="apply_abstract" name="apply_abstract" placeholder="请输入专线明细摘要" onblur="trim(this);">
					</li>
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>金额：</span>
						<input type="text" class="inputtxt2" style="width: 500px;" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" maxlength="10" id="apply_amount" name="apply_amount" placeholder="请输入申请金额" onblur="changeFloat(this);" style="ime-mode:disabled" value="0.00">
					</li>
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>日期：</span>
					 	<input class="inputtxt2" id="apply_time" name="apply_time" style="width:500px;" onfocus="WdatePicker({isShowWeek:true});" value="" type="text" placeholder="请选择申请时间">
					</li>
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>凭证号：</span>
						<input type="text" class="inputtxt2" style="width: 500px;" onkeyup="this.value=this.value.replace(/\D/g,'')" maxlength="15" id="voucher_num" name="voucher_num" placeholder="请输入凭证号" onblur="trim(this);">
					</li>
				</ul>
				<div class="form-group">
					...
					<input style="height:0.5px;width:0px;padding:0px;margin:0px; position: absolute;" id="voucher_path" maxlength="255" onblur="trim(this);" name="voucher_path" type="text" value="" />
					<input style="height:0.5px;width:0px;padding:0px;margin:0px; position: absolute;" id="voucher_name" maxlength="255" onblur="trim(this);" name="voucher_name" type="text" value="" />
				</div>
				</div>
			</form>

...
<head>
<title>修改毕业生信息_济南市服务外包公共服务平台</title>
<meta charset="UTF-8" />
	...
	<div class="register-box p0">
	    ...
	    <div class="mypage_right" style="min-height:800px">
			...
			<div class="input_class">
				<form
					action="<%=basePath%>graduate/updateGraduate.act"
					...
					<ul style="margin-bottom: 20px;">
						<li>
							...
							<input type="text" class="inputtxt2" style="width: 275px;" maxlength="5" value="${grpd.name}" onblur="trim(this);checkName();" id="graduateName" name="graduateName">
						</li>
						<li>
						<span><small style="color: red">*</small>&nbsp;身份证号：</span>
							<input id="graduateIdNumber" name="graduateIdNumber" value="${grpd.id_number}" class="inputtxt2" style="width: 275px;" type="text" maxlength="20" onblur="trim(this);"/>
						</li>
						<li><span><small style="color: red">*</small>&nbsp;学历：</span>
						<select class="inputtxt2NNew" name="education"
							id="education">
							<c:forEach items="${educationList}" var="education">
								<option value="${education.DISTINGUISH_ID}" <c:if test="${education.DISTINGUISH_ID == grpd.education}">selected</c:if>>${education.VALUE}</option>
							</c:forEach>
						</select>
						</li>
						<li><span><small style="color: red">*</small>毕业院校：</span>
						    <input class="inputtxt2" style="width:275px;" data-val="true" data-val-required="*" id="school" name="school" maxlength="14" type="text" value="${grpd.school}" onblur="trim(this);checkTeacherGraduate();"/>
						</li>
						<li><span><small style="color: red">*</small>专业：</span> 
						<select class="inputtxt2NNew" name="major"
							id="major">
							<c:forEach items="${majorList}" var="major">
								<option value="${major.DISTINGUISH_ID}" <c:if test="${major.DISTINGUISH_ID == grpd.major}">selected</c:if>>${major.VALUE}</option>
							</c:forEach>
						</select>
						</li>
						</ul>
                        ...
                        <p class="pull-left">
                                <img onerror="showImgDelay(this,'<%=basePath%>shyl/images/mylogo.jpg');" src="<%=basePath%>images/${grpd.id_path}" class="upimg" id="img_idNumber" name="img_idNumber" style="width: 100px;padding: 3px; border: solid 1px #ccc; background: #fff;" />
                        </p>
                        <input id="pictureUrl_idNumber" name="pictureUrl_idNumber" type="hidden" value="${grpd.id_path}"/>
                        <div>
                        ...
                        <p class="pull-left">
                                <img onerror="showImgDelay(this,'<%=basePath%>shyl/images/mylogo.jpg');" src="<%=basePath%>images/${grpd.diploma_path}" class="upimg" id="img_diploma" name="img_diploma" style="width: 100px;padding: 3px; border: solid 1px #ccc; background: #fff;" />
                        </p>
                        <input id="pictureUrl_diploma" name="pictureUrl_diploma" type="hidden" value="${grpd.diploma_path}"/>
                        <div>
                            	<span class="fileinput-button" style="padding-left:18px;">
				...
				<li style="line-height:30px;">
					    <span>学位证：</span>                    
                        <p class="pull-left">
                                <img onerror="showImgDelay(this,'<%=basePath%>shyl/images/mylogo.jpg');" src="<%=basePath%>images/${grpd.degree_path}" class="upimg" id="img_degree" name="img_degree" style="width: 100px;padding: 3px; border: solid 1px #ccc; background: #fff;" />
                        </p>
                        <a class="delete" style="margin:0 40px" onclick="deleteDegree();">删除</a>
                        <input id="pictureUrl_degree" name="pictureUrl_degree" type="hidden" value="${grpd.degree_path}"/>
                        <div>
                            	<span class="fileinput-button" style="padding-left:18px;">
				...
				<tr>
				   ...
				   <td style="width:50%;"><div class="col-sm-12"><ul id="pdfName" style="font-size:0.85em;">${grpd.labour_name}</ul></div></td>
				</tr>
				<tr>
				<td></td>
				...
				<div>
								...
								<span style="text-align:right;width:100px;background-color: #4f70c0;color:#FFFFFF;border-radius: 5px;line-height: 42px;text-align: center;font-size:15px;">上传劳动合同</span>
                ...
                <input id="labour_name" name="labour_name" type="hidden" value="${grpd.labour_name}">
                <input id="labour_path" name="labour_path" type="hidden" value="${grpd.labour_path}">
                <input id="id" name="id" type="hidden" value="${grpd.id}">
                <td>
				</tr>
				</table>
				</li>

...
<!DOCTYPE html>
<html lang="en">
<title>企业新闻修改_济南市服务外包公共服务平台</title>
<meta charset="UTF-8" />
<base href="<%=basePath%>">
...
<body style="background-color: #f7f7f7;">
	...
	<div class="register-box p0">
		...
		<div class="mypage_right">
			<h2 style="margin-top: 0px;">修改企业新闻</h2>
			...
			<form class="form-horizontal company_list" role="form" id="newsForm"
				...
				<input type="hidden" id="newsId" name="newsId" value="${pd.id}" />
				<input type="hidden" id="companyId" name="companyId" value="${pd.company_id}" />
				<ul style="margin-bottom: 20px;">
					<li style="width: 800px;">
					 	<span><small style="color:red">*</small>&nbsp;新闻标题：</span>
						<input type="text" class="inputtxt2" style="width: 600px;" id="news_title" name="news_title" value="${pd.title}"  placeholder="请输入新闻标题" maxlength="50" onblur="trim(this);">
					</li>
					<li style="height:260px;width: 100%;">
						<span><small style="color:red">*</small>&nbsp;新闻内容：</span>
						<textarea id="news_content" name="news_description"
												class="textareatxt2" style=" float: left;height:160px; ">${pd.content}</textarea>
					</li>
...
<!-- 富文本编辑器start -->
	...
	<script type="text/javascript">
		...
		function save(){
			if(localcheck()){
				$("#newsForm").attr('action','<%=basePath%>companyNews/updateNews.act');
				$("#newsForm").submit();

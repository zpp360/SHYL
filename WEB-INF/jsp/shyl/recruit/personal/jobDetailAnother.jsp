...
<div class="register-box clearfix">
	...
	<div class="register-box-1" style="width:100%;">
		...
		<div class="register-box-right">
			...
			<a onclick="Tip('favsqzw');" class="qy_shoucang" style="float: left;">投简历</a></p><p class="text-center" data-toggle="modal" id="favpost"  data-target="#layhomewarn"><a onclick="TipFav('favpost');" class="qy_shoucang">收藏</a></p></div>
		...
		<div class="modal-dialog modal-sm" style="margin-top:250px">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<button id="sendcv" class="btn btn-success" onclick="sendCv('sendcv');" data-toggle="modal" data-dismiss="modal">确定</button>

...
<!DOCTYPE html>
<html lang="en">
<title>发布咨询服务_济南市服务外包公共服务平台</title>
<meta charset="UTF-8" />
<base href="<%=basePath%>">
...
<body style="background-color: #f7f7f7;">
	...
	<div class="register-box p0">
		...
		<div class="mypage_right">
			<h2 style="margin-top: 0px;">发布咨询服务</h2>
			<div class="input_class" style="margin-bottom: 100px;">
			<form class="form-horizontal company_list" role="form" id="Form"
							name="Form" action="<%=basePath%>consultancy/save.act" method="post">
				<ul style="margin-bottom: 20px;">
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>咨询标题：</span>
						<input type="text" class="inputtxt2" style="width: 600px;" id="title" name="title" maxlength="50" placeholder="请输入咨询服务标题" onblur="trim(this);">
					</li>
					<li>
						...
						<c:forEach items="${typeList}" var="pd">
						<option value="${pd.DISTINGUISH_ID}">${pd.VALUE}</option>
						</c:forEach>
						</select>
					</li>
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>咨询人：</span>
						<input type="text" class="inputtxt2" style="width: 600px;" id="person" name="person" maxlength="30" placeholder="请输入咨询人" onblur="trim(this);">
					</li>
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>联系电话：</span>
						<input type="text" class="inputtxt2" style="width: 600px;" id="tel" name="tel" maxlength="13" placeholder="请输入联系电话" onblur="trim(this);">
					</li>
					<li style="height:120px;width: 100%;">
						<span id="PShow" style="display: block;"><small style="color: red;">*</small>缩略图：</span>
<!-- 						<span id="PNShow" style="display: block;">缩略图：</span> -->
					...
					<li style="height:260px;width: 100%;">
						...
						<textarea id="contentc" name="contentc" class="textareatxt2" style=" float: left;height:260px;"></textarea>
					</li>

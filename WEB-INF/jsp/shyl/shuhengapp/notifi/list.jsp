...
<body>
	<section class="container">
		...
		<h2 class="subhead">${pd.notifi_title_other}</h2>
		<div class="standard">
		<c:if test="${!empty pd.insert_time}"><div class="date">发布日期：${pd.insert_time }</div></c:if>
		</div>
		<div class="content">
			　　${pd.notifi_content}
		</div>
	...
	<div class="standard">
		<c:if test="${!empty pd.notifi_source}"><div class="source">来源：${pd.notifi_source}</div></c:if>
	</div>

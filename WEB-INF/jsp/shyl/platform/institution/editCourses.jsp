...
<html lang="en">
<head>
<title>培训课程信息编辑_济南市服务外包公共服务平台</title>
<meta charset="UTF-8" />
...
<body id="top" style="background-color: #f7f7f7;">
	...
	<div class="register-box p0">
		...
		<div class="mypage_right">
			<h2>课程信息</h2>
			<form
				action="<%=basePath%>institutionCtrl/courseUpdate.act?course_id=${pd.course_id}"
				...
				<div class="input_class">
					<ul>
						<li><span><small style="color: red">*</small>课程名称：</span> <input
							...
							onblur="trim(this);checkCourseName();" id="course_name"
							name="course_name" size="50" maxlength="20" type="text"
							value="${pd.course_name}" placeholder="请输入培训课程名称" /> <span
						...
						<li><span><small style="color: red">*</small>课时(节)：</span> <input
							...
							name="period" maxlength="10" type="text" value="${pd.period}"
					...
					<ul>
						<li><span><small style="color: red">*</small>时长(分钟)：</span> <input
							...
							type="text" value="${pd.course_time}" placeholder="请输入培训课程时长"
						...
						<li><span><small style="color: red">*</small>讲师：</span> <select
							class="inputtxt2" id="teacher" name="teacher"><option
								...
								<c:forEach items="${teacherList}" var="vars">
									<option value="${vars.teacher_name}"
										<c:if test="${vars.teacher_name == pd.teacher }">selected</c:if>>${vars.teacher_name}</option>
								</c:forEach>
						</select></li>
					</ul>
					<ul>

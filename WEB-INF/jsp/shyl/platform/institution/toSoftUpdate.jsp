...
<html lang="en">
<head>
<title>修改软硬件汇总_济南市服务外包公共服务平台</title>
<meta charset="UTF-8" />
...
<body id="top" style="background-color: #f7f7f7;">
	...
	<div class="register-box p0">
		...
		<div class="mypage_right">
			<h2>修改软硬件汇总</h2>
			<form action="<%=basePath%>org/updateSoft.act"
				...
				<div class="input_class">
					...
					<li style="width: 800px;">
						...
						<input type="text"  value="${pd.apply_date }" class="inputtxt2" style="width: 600px;" onFocus="WdatePicker({isShowWeek:true});" id="soft_time" name="soft_time" placeholder="日期">
					</li>
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>凭证号数：</span>
						<input type="text" value="${pd.voucher}" maxlength="5" class="inputtxt2" style="width: 600px;" id="voucher" name="voucher" placeholder="凭证号数">
					</li>
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>摘要：</span>
						<input type="text" value="${pd.abstract_info}" maxlength="50" onblur="trim(this);" class="inputtxt2" style="width: 600px;" id="abstract_info" name="abstract_info" placeholder="摘要">
					</li>
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>人民币（元）：</span>
						<input type="text" value="${pd.rmb }" maxlength="10" class="inputtxt2" style="width: 600px;" id="rmb" name="rmb" placeholder="人民币" onkeyup="value=value.replace(/[^\d{1,}\.\d{1,}|\d{1,}]/g,'')" onblur="changeFloat(this);" style="ime-mode:disabled">
					</li>
					<li style="width: 800px;">
					 	<span><small style="color: red">*</small>备注：</span>
						<input type="text" value="${pd.remarks }" maxlength="50" onblur="trim(this);" class="inputtxt2" style="width: 600px;" id="remarks" name="remarks" placeholder="备注">
					</li>
					<li style="width: 800px;">
							...
							onclick="GetCity()" onchange="checkProvinceId();">
								<c:forEach items="${SoftType}" var="role">
									<option value="${role.DISTINGUISH_ID}"
										<c:if test="${role.DISTINGUISH_ID == pd.soft_type}">selected</c:if>>${role.VALUE}</option>
								</c:forEach>
						</select>
						</li>
				</ul>

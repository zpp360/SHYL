...
<html lang="en">
<head>
<title>培训讲师信息编辑_济南市服务外包公共服务平台</title>
<meta charset="UTF-8" />
...
<body id="top" style="background-color: #f7f7f7;">
	...
	<div class="mypage_right">
		<h2>师资信息</h2>
		<form action="<%=basePath%>institutionCtrl/teacherUpdate.act?teacher_id=${pd.teacher_id}" class="form-horizontal" id="form1" method="post">
	    <!-- start -->
        <input type="hidden" id="result" name="result" value="${pd.result}">
        <input type="hidden" id="institutions_id" name="institutions_id" value="${pd.institution_id}">
...
<ul>
			<li><span><small style="color: red">*</small>姓名：</span>
                        <input class="inputtxt2" data-val="true" data-val-required="*" id="teacher_name" name="teacher_name" size="50" maxlength="9" type="text" value="${pd.teacher_name}" onblur="trim(this);checkTeacheName();" placeholder="请输入讲师姓名"/>
				...
				<li><span><small style="color: red">*</small>毕业院校：</span>
                        <input class="inputtxt2" data-val="true" data-val-required="*" id="graduate" name="graduate" maxlength="20" type="text" value="${pd.graduate}" onblur="trim(this);checkTeacherGraduate();" placeholder="请输入讲师毕业院校" />
                        <span class="field-validation-valid" data-valmsg-for="Phone" data-valmsg-replace="true"></span>
				</li>
			</ul>
			<ul>
			<li><span><small style="color: red">*</small>职称：</span>
                        <input class="inputtxt2" data-val="true" data-val-required="*" id="teacher_level" name="teacher_level" size="50" maxlength="10" type="text" value="${pd.teacher_level}" onblur="trim(this);checkTeacherLevel();" placeholder="请输入讲师职称"/>
                        <span class="field-validation-valid" data-valmsg-for="Contact" data-valmsg-replace="true"></span>
				</li>
				<li><span><small style="color: red">*</small>手机号码：</span>
                        <input class="inputtxt2" data-val="true" data-val-required="*" id="phone" name="phone" onkeyup="value=value.replace(/[^0-9]/g,'')" maxlength="20" type="text" value="${pd.phone}" onblur="checkTeacherPhone();delZero(this);" placeholder="请输入讲师联系手机号码" style="ime-mode:disabled"/>
                        <span class="field-validation-valid" data-valmsg-for="Phone" data-valmsg-replace="true"></span>
				</li>
			</ul>
			<ul>
			<li><span><small style="color: red">*</small>邮箱：</span>
                        <input class="inputtxt2" data-val="true" data-val-required="*" id="email" name="email" size="50" maxlength="64" type="text" value="${pd.email}" onblur="trim(this);checkTeacherEmail();" placeholder="请输入讲师邮箱地址"/>
                        <span class="field-validation-valid" data-valmsg-for="Contact" data-valmsg-replace="true"></span>
				</li>
			</ul>
			<ul>
				<li style="height:120px;width: 100%;">
					<span>个人头像：</span>                    
                        <p class="pull-left">
                                <img onerror="showImgDelay(this,'<%=basePath%>shyl/images/default/teacher.png');" src="<%=basePath%>images/${pd.teacher_picture}" class="upimg" id="imgP" name="imgP" style="width: 100px; padding: 3px; border: solid 1px #ccc; background: #fff;" />
                        </p>
                        <input id="teacher_picture" name="teacher_picture" type="hidden" value="${pd.teacher_picture}" />
				...
				<li style="height:80px;width: 100%;">
				     <span>简介：</span>
                        <textarea style="width:700px;padding-left:5px;background-color:#ecf0f9;border:0;border-radius:5px;font-size:0.85em;resize:none!important;" rows="2" maxlength="500" id="experience" name="experience">${pd.experience}</textarea>
				</li>
			</ul>
		</div>
        </form>
